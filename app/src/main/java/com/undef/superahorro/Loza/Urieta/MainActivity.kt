...
import com.undef.superahorro.Loza.Urieta.data.SuperAhorroRepository // 📍 MODIFICACIÓN 1: Importamos tu nuevo repositorio
...
class tomiMainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 📍 MODIFICACIÓN 2: Instanciamos el repositorio único aquí, antes del setContent
            ...
            SuperAhorroTheme(darkTheme = AppSettings.darkMode) {
                ...
                CompositionLocalProvider(
                    ...
                    Surface(modifier = Modifier.fillMaxSize()) {
                        ...
                        // 📍 MODIFICACIÓN 3: Le pasamos el repositorio al grafo de navegación
                        SuperAhorroNavGraph(repository = repository)
                    }
                }
            }
        }
